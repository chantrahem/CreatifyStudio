<?php 
$title = 'Thank You - CreatifyStudio';
$page = 'thank-you';
        ...
        <div class="max-w-4xl mx-auto text-center">
            ...
            <?php if ($status === 'success'): ?>
                ...
                <p class="text-xl md:text-2xl text-green-100 mb-8 animate-fade-in-delay">
                    Your message has been sent successfully. We appreciate you reaching out to CreatifyStudio!
                </p>
            ...
            <?php else: ?>
                ...
                <p class="text-xl md:text-2xl text-blue-100 mb-8">
                    We appreciate your interest in CreatifyStudio.
                </p>
            <?php endif; ?>
